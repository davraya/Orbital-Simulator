 ...
 * Author:
 *    Br. Helfrich, Sam Cummings and David Raya
 * Summary:
...
public:
    ...
    void update(Acceleration* a, Velocity* v, double t) { acceleration = a; velocity = v; this->t = t; }
    ...
    void computeNewPostion(Velocity* vel, Acceleration* acc);
...
private:
    ...
    double t;
    void computeX(double dx, double ddx, double t);
    void computeY(double dy, double ddy, double t);
};
